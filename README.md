...
| 단계 | 설명 |
|------|------|
| **1️⃣ 입력** | 당신이 "AI 역량 강화 계획 작성해줄래?"라고 말하거나 자료를 주면 AI가 듣고 시작합니다 |
| **2️⃣ 양식 선택** | 분량과 받는 사람에 맞춰 **한 장 보고서 / 풀버전 / 공문 / 이메일** 중에서 추천합니다 |
| **3️⃣ 글쓰기 다듬기** | **결론부터 / 한 문장 한 가지 / 핵심만 짧게** 라는 규칙을 자동으로 적용하고, 보고 종류에 맞는 목차 구조도 넣습니다 |
| **4️⃣ 양식에 채우기** | ⭐ **핵심**: 회사 양식의 표·테두리·로고는 그대로 두고 **글만 빈 칸에 채워 넣습니다** |
| **5️⃣ 완성** | 한글 프로그램에서 열면 회사 양식 그대로 보입니다. 필요한 부분만 살짝 다듬어서 바로 결재 올리기 가능합니다 |

### 🎯 핵심 원칙

> **양식은 그대로 살리고, 내용만 새로 채워 넣습니다.**

- ✅ **양식 디자인 100% 보존** — 표, 테두리, 음영, 로고, 결재선 모두 그대로
- ✅ **빠른 완성** — 큼지막한 부분은 AI가 해주고, 세부 조정만 하면 됨
- ✅ **회사 양식 적용 가능** — 참조 hwpx 파일을 주면 그 양식을 우선 적용
